<?php
class M_undiancrud5 extends CI_Model {
////////////////////////////////////////
	var $ipaddress;
	var $nomor_undian; 
	var $hasil_pencarian ; 
	...
	function __construct() 
	{
		...
		if(is_null($this->hasil_pencarian)){ 
			...
			$this->messageRecorded = "record added with nomor undian ".$this->nomor_undian;
			} else $this->messageQuotaHabis = "Quota habis";
		}
		else 
		{

			$this->messageRecorded = "Kamu sudah terdaftar, nomor undian kamu adalah : ".$this->hasil_pencarian;
		}
	}
